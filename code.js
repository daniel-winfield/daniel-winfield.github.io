...
var app = new Vue({
  ...
  data: {
    ...
    socialLinks: [
      {
        name: "GitHub",
        url: "https://github.com/daniel-winfield",
        title: "github.com/daniel-winfield",
        iconClass: "fab fa-github",
      },
      {
        name: "LinkedIn",
        url: "https://www.linkedin.com/in/danielwinfield1/",
        title: "linkedin.com/in/danielwinfield1",
        iconClass: "fab fa-linkedin-in",
      },
      {
        name: "Email",
        url: "mailto:me@danielwinfield.uk",
        title: "me@danielwinfield.uk",
    ...
    about: {
      title: "About me",
      description:
        "I am a full-stack Software Engineer based in the Midlands. I currently work for Saggezza Ltd working on a modernisation program for a client in the legal industry. I previously worked on a suite of products at Imosphere utilising .NET Framework, .NET Core, C#, JavaScript, TypeScript, HTML, CSS and T-SQL. I hold a first-class undergraduate degree, BSc (Hons) Computer Science, from Nottingham Trent University.",
      ...
      items: [
        {
          ...
          description:
            "This application tracks the rollout of vaccines in the United Kingdom. The data is sourced directly from the GOV.UK API in JSON format. A GitHub action is used to update the data periodically throughout the day on a set cron schedule.",
          imageUrl: "images/projects/uk-covid-tracker.png",
          projectUrl: "https://danielwinfield.uk/uk-covid-vaccine-tracker/",
          codeUrl:
            "https://github.com/daniel-winfield/uk-covid-vaccine-tracker/",
        },
      ],
    },
    skills: {
      ...
      tools: {
        ...
        items: [
          ...
          { name: "Jira", iconClass: "fab fa-jira" },
        ],
      },
      platforms: {
        title: "Platforms",
      ...
      items: [
        {
          ...
          positions: [
            ...
            },
            {
              ...
              description:
                "Responsible for designing and implementing features and bug fixes on the Atmolytics healthcare software platform (C#, ASP.NET, TypeScript, SQL), and for developing for the Resource Allocation System (SQL) in use by councils and CCG's across the United Kingdom.",
            },
            {
          ...
          positions: [
            {
              ...
              endDate: new Date(2019, 6),
              description:
                "Responsible for designing, implementing, and maintaining the website through the WordPress platform.",
            },
          ],
          ...
          positions: [
            {
              ...
              endDate: new Date(2019, 6),
              description:
                "Responsible for improving and updating the website through the Joomla platform.",
            },
          ],
